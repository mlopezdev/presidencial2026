  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        ...
        <h3 style={{ margin: "0 0 10px", fontSize: 32, fontWeight: 600, letterSpacing: "-0.025em", color: "var(--ink)", lineHeight: 1.1,
          fontFamily: "var(--font-plex-serif), Georgia, serif" }}>
          ¿Hacia dónde apunta cada candidato?
        </h3>
        <p style={{ margin: "0 0 16px", fontSize: 16, color: "var(--ink-2)", lineHeight: 1.55, maxWidth: 780 }}>
