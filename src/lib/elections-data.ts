...
export const EL_NATIONAL: Record<number, ElectionYear> = {
  ...
  2022: {
    abstencion: 45.0, turnout: 55.0, totalVotes: 21_359_932,
    r1: [
      { name: "Gustavo Petro", pct: 40.32, votes: 8_527_768 },
      { name: "Rodolfo Hernández", pct: 28.15, votes: 5_953_209 },
      { name: "Federico Gutiérrez", pct: 23.91, votes: 5_058_010 },
      { name: "Sergio Fajardo", pct: 4.20, votes: 888_585 },
      { name: "Íngrid Betancourt", pct: 1.40, votes: 296_940 },
    ],
    r2: [
      { name: "Gustavo Petro", pct: 50.44, votes: 11_291_986 },
      { name: "Rodolfo Hernández", pct: 47.31, votes: 10_580_412 },
    ],
